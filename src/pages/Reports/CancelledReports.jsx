...
import CancelledReportChart from '../../components/chartReports/CancelledReportChart';
...
const CancelledReports = () => {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: "Cancelled Report",
    });
    

    const { cancelledReport, getCancelledReport, isLoading, error } = useAuthStore();

    useEffect(() => {
        const fetchData = async () => {
            try {
                await getCancelledReport(filter);
            } catch (error) {
    ...
    const cancelledReportData = cancelledReport?.tableData || []; // FIX: correctly map the "table" from API response
        ...
        <div className="flex flex-col space-y-6 px-4 pt-0 pb-8">
            ...
            <div ref={printRef}>
                ...
                <div className="w-full flex justify-center items-center print:pt-40">
                    <ChartBoxReport>
                        <CancelledReportChart filter={filter} />
                    </ChartBoxReport>
                </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="w-full">
                            <table className="w-full table-auto border border-gray-200 rounded-lg">
                                ...
                                <tbody>
                                    {cancelledReportData.map((reservation) => (
